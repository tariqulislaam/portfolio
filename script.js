...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const githubLogo = document.querySelector('img[alt="facebook logo"]');
  const linkedinLogo = document.querySelector('img[alt="linkedin logo"]');
  const instagramLogo = document.querySelector('img[alt="insta logo"]');
  const emailLogo = document.querySelector('img[alt="email logo"]');

  const lightLogos = {
    github: "assets/facebook-white.png",
    linkedin: "assets/linkedin_light.png",
    instagram: "assets/insta-white.png",
    email: "assets/email_light.png",
    theme: "assets/theme_light.png",
  };

  const darkLogos = {
    github: "assets/facebook-black.png",
    linkedin: "assets/linkedin_dark.png",
    instagram: "assets/insta-black.png",
